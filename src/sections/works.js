        ...
        <div>
            ...
            <div className="row">
                ...
                <div className="row-right">
                    ...
                    <p> Gin-gonic 프레임워크를 이용하여 내부 서비스를 개발하고 있습니다.</p>
                    
                    <h5>What did I do<span className="period-mark">.</span></h5>
                    <ul> 
                        <li> 요구사항에 맞추어 RESTfull 설계를 하였습니다. </li> 
                        <li> Go report, GORM 등 다양한 오픈소스를 활용하여 code quality check, ORM을 활용합니다. </li> 
                        <li> Travis CI 등을 이용하여 간단한 CI를 구축할 수 있고 활용하고 있습니다. </li> 
            ...
            <div className="row">
                <div className="row-left">
                    ...
                    <span className="role">Field practice</span>
                    <span>
